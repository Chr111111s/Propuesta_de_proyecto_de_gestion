                        ...
                        {movements.slice(0, 10).map((movement) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={[
                                        'block rounded-[22px] border p-4 transition-all',
                ...
                <div className="space-y-6">
                        ...
                        <ul className="timeline timeline-snap-icon timeline-vertical">
                            {timeline.map((step, index) => (
                                <li key={step.title}>
                                    ...
                                    <div className="timeline-end mb-8 rounded-[22px] border border-base-200 bg-base-100 p-4 shadow-sm">
                    ...
                    <section className="grid gap-6 xl:grid-cols-2">
                        <SectionCard title="Ficha logística" description="Datos consolidados del envío actual.">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="rounded-2xl border border-base-200 bg-base-200/25 p-4">
                                    ...
                                    <p className="mt-2 text-lg font-bold">{selectedMovement ? `${formatNumber(selectedMovement.quantity)} uds.` : '0 uds.'}</p>
                                </div>
                                <div className="rounded-2xl border border-base-200 bg-base-200/25 p-4">
                                    <p className="text-sm text-base-content/55">Volumen</p>
                                    <p className="mt-2 text-lg font-bold">{selectedMovement ? formatVolume(selectedMovement.volume_m3) : '0 m³'}</p>
                                </div>
                                <div className="rounded-2xl border border-base-200 bg-base-200/25 p-4">
                        ...
                        <SectionCard title="Estado de traslado" description="Contexto operativo para el responsable y la mesa de control.">
                            <div className="rounded-[24px] bg-primary p-5 text-primary-content">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <p className="text-xs font-semibold text-primary-content/75">Pedido activo</p>
                                        <h3 className="mt-3 text-2xl font-black">{selectedMovement?.folio ?? 'Sin folio'}</h3>
